...
from modules.backoffice.product.infrastructure.controllers import AllServicesController
from modules.backoffice.product.infrastructure.controllers import ServiceFinderController
from modules.backoffice.product.infrastructure.controllers import ServiceCreatorController
from modules.backoffice.product.infrastructure.controllers import ServicePatcherController
from modules.backoffice.product.infrastructure.controllers import ServiceDeleterController

namespace = Namespace(name="product", description="Services Catalog")

...
# from sqlalchemy_models import PaymentMethod
# target_metadata = mymodel.Base.metadata
from sqlalchemy_models.user_model import metadata
...
environ = PyEnviron()
alchemy_session_creator = AsyncAlchemySessionCreator(
...
config.set_main_option('sqlalchemy.url', alchemy_session_creator.get_url_database())

...
from modules.backoffice.payment_method.application.all import AllPaymentMethods
...
class AllPaymentMethodsController:
    ...
    def __call__(self):
        try:
            ...
            response = {"success": True, "message": "OK", "data": payment_methods}, status.HTTP_200_OK
